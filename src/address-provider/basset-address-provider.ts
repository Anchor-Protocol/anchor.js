...
type KnownAsset = 'bLUNA' | 'bETH';

export const bAssetAddressesColumbus5: Record<KnownAsset, BAssetAddressMap> = {
  bLUNA: {
  ...
  bETH: {
    ...
    converter: 'terra1emvfel8x7wmvkwjfq3jpa6sq4nsfjjqjm7ucnl',
    custody: 'terra10cxuzggyvvv44magvrh3thpdnk9cmlgk93gmx2',
    wormhole: 'terra1u5szg038ur9kzuular3cae8hq6q5rk5u27tuvz',
  },
};

export const bAssetAddressesBombay12: Record<KnownAsset, BAssetAddressMap> = {
  bLUNA: {
